                ...
                <tr>      
                    ...
                    <td>  
                        <?php if($produto["cor"] == 'azul')  {
                            ...
                            $desc = (intval($produto['preco']) * 0.2);
                            echo  "R$ " . ((intval($produto['preco']) - $desc)) ;
                        
                        }elseif (($produto["cor"] == 'vermelho') AND ($produto['preco'] > 50)){                            

                            $desc = (intval($produto['preco']) * 0.05);
                            echo  "R$ " . ((intval($produto['preco']) - $desc)) ;
                            ...
                            $desc = (intval($produto['preco']) * 0.5);
                            echo  "R$ " . ((intval($produto['preco']) - $desc)) ;

                        }else{

                            echo "R$ " . intval($produto['preco']);
                        }
